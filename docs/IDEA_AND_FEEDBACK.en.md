...
- Long-term gaze tracking may cause eye fatigue, so rest reminders, sampling-duration visibility, and camera-off modes should be considered.
...
- Treats explicit text selection as a strong signal and gaze dwell as a weak signal, avoiding direct claims that gaze coordinates equal understanding.
...
- Before note generation, the app could show strong signals, weak signals, and evidence gaps so users can confirm what AI will use.
